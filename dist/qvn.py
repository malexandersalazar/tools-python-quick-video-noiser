...
def run(video_file,noise_type):
    ...
    new_working_dir = current_video_dir + "\\" + input_filename_without_ext
    ...
    subprocess.run(join_frames_to_video(altered_frames_directory + "\\%04d.jpg", current_video_dir, input_filename_without_ext))
